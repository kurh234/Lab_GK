...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[1], 0);
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[1], 4 );
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[1], 8 );
		gl2.glMaterialf( GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[1][12] );

		int n = 10; // ilosc bokow
		int r = 6; // promien
		float y = -1;
		int h = 7; // wysokosc
		float x,z;
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl2.glLightfv(GL2.GL_LIGHT1,GL2.GL_AMBIENT ,white,1);
